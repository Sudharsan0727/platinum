...
const ThankYou = () => {
    ...
    const handleDownload = async (e) => {
        e.preventDefault();
        const pdfUrl = "https://www.radiancerealty.in/images/pdf/radiance_platinum_brochure.pdf";
        const fileName = "radiance_platinum_brochure.pdf";
                ...
                <div className="lux-container relative z-10 text-center max-w-4xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-up animate-delay-1 mt-12">
                        ...
                        <a 
                            ...
                            className="group bg-[#f4f3ff] p-8 rounded-sm border border-gray-100 transition-all duration-500 hover:bg-[#03012C] hover:-translate-y-2 cursor-pointer shadow-sm flex flex-col items-center no-underline"
                        >
                        ...
                        <button 
                            ...
                            className="group bg-[#f4f3ff] p-8 rounded-sm border border-gray-100 transition-all duration-500 hover:bg-[#03012C] hover:-translate-y-2 cursor-pointer shadow-sm flex flex-col items-center no-underline w-full"
                        >
                            <div className="text-gold group-hover:text-white transition-colors duration-500 mb-6 flex justify-center">
                                <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
