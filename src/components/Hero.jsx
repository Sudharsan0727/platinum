...
import heroBg from '../assets/img/desktopbanner.jpeg';
import heroMobileBg from '../assets/img/mobilebanner.jpeg';
...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative flex flex-col lg:block h-auto lg:h-[90vh] 2xl:h-[95vh] pt-[72px] lg:pt-0 overflow-hidden bg-[#f4f3ff] lg:bg-white">      {/* Background Image - Desktop */}
      ...
      <div className="relative z-10 lux-container w-full py-6 lg:py-0 lg:absolute lg:top-1/2 lg:-translate-y-1/2 lg:left-0 lg:right-0">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 lg:col-start-8">
            <div className="bg-[#03012C] lg:bg-white p-6 md:p-8 rounded-sm relative z-10 shadow-xl lg:shadow-2xl border border-gold/20 lg:border-none mx-auto max-w-lg lg:max-w-none">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <button 
                  ...
                  className={`w-full bg-white text-[#03012C] lg:bg-[#03012C] lg:text-white lg:btn-gold font-bold uppercase tracking-widest py-3 text-xs lg:!py-3 shadow-xl mt-2 transition-all hover:bg-white/90 lg:hover:bg-gold-dark ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                >
