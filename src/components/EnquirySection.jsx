...
import enquiry1 from '../assets/img/platinum/Cam_02_Night.jpg';
import enquiry2 from '../assets/img/platinum/Cam_02_Day.jpg';
            ...
            <div className="lux-container">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                    ...
                    <div className="animate-fade-up animate-delay-2 order-1 lg:order-2">
                        ...
                        <div className="bg-[#f4f3ff] p-8 md:p-10 rounded-sm shadow-sm border border-luxury-gray/30">
